...
interface AssignedLead extends Lead {
  profiles: {
    first_name: string;
    last_name: string;
  } | null;
              ...
              <>
                <div className="flex-grow">
                  <Table>
                    ...
                    <TableBody>
                      {assignedLeads?.data?.map((lead: AssignedLead, index: number) => (
                        <motion.tr
                          key={lead.id}
                          variants={rowVariants}
                          initial="hidden"
                        ...
                        >
                          ...
                          <TableCell>{lead.phone}</TableCell>
                          <TableCell>{lead.source}</TableCell>
                          <TableCell>{`${lead.profiles?.first_name ?? ''} ${lead.profiles?.last_name ?? ''}`.trim() || 'Unassigned'}</TableCell>
                          <TableCell>
                            <Button
                              variant="destructive"
                              size="sm"
